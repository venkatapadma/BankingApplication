...
A full‑stack backend banking application built using Spring Boot 4, Spring Data JPA (Hibernate), MySQL, and Java 25, following SOLID principles and clean architecture best practices.

This application exposes RESTful APIs to manage bank accounts and transactions such as create account, deposit, withdraw, view accounts, delete account, with global exception handling using @ControllerAdvice.
...
git clone [https://github.com/your-username/BankingApplication.git](https://github.com/venkatapadma/BankingApplication.git)
